...
declare const styled: (<TBaseProps extends {}>(Component: React.FunctionComponent<TBaseProps>) => <TProps extends {}>(styles: TemplateStringsArray, ...values: CSSInterpolation<TProps & {
    ...
    feDiffuseLighting: <TProps_135 extends Record<string, unknown>>(styles: TemplateStringsArray, ...values: CSSInterpolation<TProps_135 & {
        theme: YakTheme;
    }>[]) => React.FunctionComponent<React.SVGProps<SVGFEDiffuseLightingElement> & TProps_135>;
